...
- Open `DIAGRAMS.md` — walk the diagrams in order: diagram 1 (Workflow Execution Flow) sets the business context; diagram 2 (System Architecture) shows how it's built; diagram 3 (Agent Layer) drills into the agent box — tool-calling loop, read vs write tool split, direct service calls.
...
## Act 3 — Request Submission & Conditional Step Skipping (2 min)

**Postman section 3 — Request Submission**
...
## Act 4 — Approval Chain + REQUEST_CHANGES Loop (4 min)

**Postman section 4 — Approval Inbox & Decisions**

Run the requests top to bottom — the $15k chain and $7k loop are interleaved:
...
## Act 5 — Delegation (2 min)

**Postman section 5 — Delegation**

A fresh $2,500 travel request is submitted so Manager has a pending item to delegate (Act 4 approved everything).
...
## Act 6 — Group-Based Approval (3 min)

**Postman section 6 — Group Approval**
...
## Act 7 — Parallel Approval (3 min)

**Postman section 7 — Parallel Approval**
...
## Act 9 — AI Agent (8 min) ← CENTERPIECE

**Postman section 9 — Agent Chat**
...
### 9a. Normal Flow — Create Template, Submit, Approve
...
### 9b. Delegation — Manager Delegates to VP
...
### 9c. Group Approval — ALL_OF Finance Committee
...
### 9d. Parallel Approval — Manager & Finance in Parallel, then VP
...
### 9e. Escalation — Times Out to VP (60s with demo config)
