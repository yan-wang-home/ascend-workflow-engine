...
-- Seed the demo admin user (password: password123).
-- All other demo users (Manager, Finance, VP, Requester) are registered via
-- Postman section 1 using the admin token, so they get the correct role.
